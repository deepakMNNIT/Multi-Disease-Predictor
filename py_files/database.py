...
def init_db():
    ...
    p1 = Diabetes_Procedures(conf='50', procedure="N/A")
    db_session.add(p1)
    p2 = Diabetes_Procedures(conf='60', procedure="Proper food.")
    db_session.add(p2)
    p3 = Diabetes_Procedures(conf='80', procedure="Exercise.")
    db_session.add(p3)
    p4 = Diabetes_Procedures(conf='100', procedure="Laparoscopy, surgical, gastric restrictive procedure; with gastric bypass and Roux-en-Y gastroenterostomy (Roux limb 150cm or less) Laparoscopy, surgical, gastric restrictive procedure; with gastric bypass and small intestine reconstruction to limit absorption")
    db_session.add(p4)
